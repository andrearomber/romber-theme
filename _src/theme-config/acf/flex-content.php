            ...
            'layouts' => array(			
                ...
                'layout_text_media' => array(
                    ...
                    'sub_fields' => array(
                        ...
                        array(
                            'key' => 'field_text_media_alignment',
                            'label' => 'Alineamiento de los textos',
                            'name' => 'alignment',
                            'type' => 'select',
                            'default_value' => 'align-left display-left',
                            'choices' => array(
                                'align-left display-left' => 'Izquierda',
                                'align-center display-center'  => 'Centro',
                                'align-right display-right'  => 'Derecha',
                            )
                        ),
                        array(
                ...
                'layout_form' => array(
                    ...
                    'sub_fields' => array(
                        ...
                        array(
                            'key' => 'field_form_alignment',
                            'label' => 'Alineamiento de los titulos',
                            'name' => 'position',
                            'type' => 'select',
                        ...
                        array(
                            'key' => 'field_form_squeeze_page',
                            'label' => 'SQUEEZE PAGE',
                            'instructions' => 'Elige esta opción si ÚNICAMENTE vas a crear una página para el formulario.',
                            'name' => 'squeeze_page',
                            'type' => 'true_false',
                            'required' => 0,
                            'default_value' => 0,
                        ...
                        array(
                            'key' => 'field_form_url_redirect',
                            'label' => 'URL Redireccionamiento',
                            'instructions' => 'URL a la que diriguira una vez enviado el formulario (si no se pone nada no se rediccionará)',
                            'name' => 'url_redirect',
                            'type' => 'text',
                        ),
                        array(
                            'key' => 'field_form_autoplay',
                            'label' => 'Autoplay',
                            'name' => 'autoplay',
                            'type' => 'true_false',
                            'required' => 0,
                ...
                'layout_product_card' => array(
                    ...
                    'sub_fields' => array(
                        ...
                        array(
                            'key' => 'field_product_card_hero',
                            'label' => 'Imagen transparente del producto',
                            'instructions' => 'Puede dejarse vacía para que sólo se vea la imagen de fondo.',
                            'name' => 'hero',
                            'type' => 'image',
                            'return_format' => 'array',
                            'library' => 'all',
                ...
                'layout_card_row' => array(
                    'key' => 'layout_card_row',
                    'name' => 'card_row',
                    'label' => 'Fila de tarjetas',
                    'display' => 'row',
                    'sub_fields' => array(
                        array(
                            'key' => 'field_card_row_title',
                            'label' => 'Título',
                            'instructions' => '',
                            'name' => 'title',
                            'type' => 'text',
                        ...
                        array(
                            'key' => 'field_card_row_size',
                            'label' => 'Tamaño de las tarjetas',
                            'name' => 'size',
                            'type' => 'select',
                            'default_value' => 'cards-medium',
                            'choices' => array(
                                'cards-large' => 'Grandes (2 por fila)',
                                'cards-medium'  => 'Medianas (3 por fila)',
                            )
                        ),
                        array(
                            'key' => 'field_card_row_repeater',
                            'label' => 'Tarjetas',
                            'name' => 'cards_repeater',
                            'type' => 'repeater',
                            'layout' => 'row',
                ...
                'layout_cta_section' => array(
                    ...
                    'sub_fields' => array(
                        ...
                        array(
                            'key' => 'field_cta_bg_backdrop_blur',
                            'label' => 'Difuminar el fondo',
                            'name' => 'bg_backdrop_blur',
                            'type' => 'true_false',
                            'required' => 0,
                ...
                'layout_scroller' => array(
                    ...
                    'sub_fields' => array(
                        array(
                            'key' => 'field_scroller_title',
                            'label' => 'Título',
                            'name' => 'title',
                            'type' => 'text',
                        ),
                        array(
                            'key' => 'field_scroller_size',
                            'label' => 'Tamaño',
                            'name' => 'logo_size',
                            'type' => 'select',
                            'default_value' => 'default',
                        ...
                        array(
                            ...
                            'sub_fields' => array(
                                array(
                                    'key' => 'field_scroller_row_items',
                                    'label' => 'Lista de logos',
                                    'name' => 'scroller_row_items',
                                    'type' => 'repeater',
                                    'layout' => 'table',
                                    'sub_fields' => array(
                                        array(
                                            'key' => 'field_scroller_item_link',
                                            'label' => 'Enlace',
                                            'instructions' => 'Si se deja vacío, la imagen no tendrá enlace.',
                                            'name' => 'item_link',
                                            'type' => 'link',
                                            'return_format' => 'array',
                                        ),
                                        array(
                                            'key' => 'field_scroller_item_img',
                                            'label' => 'Imagen o logo',
                                            'name' => 'item_img',
                                            'type' => 'image',
                                            'return_format' => 'array',
                                    ...
                                    'button_label' => 'Añadir logo a la fila',
                                ),
                            ),
