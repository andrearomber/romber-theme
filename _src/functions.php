...
function custom_theme_setup() {
    ...
    register_nav_menus( array(
        'top'   => esc_html__('Barra de navegación superior', 'romber-theme'),
        'footer-cols'   => esc_html__('Columnas en pie de página', 'romber-theme'),
    ) );
}
...
// WP
require_once WP_CONTENT_DIR . '/themes/romber-theme/theme-config/utility.php';
require_once WP_CONTENT_DIR . '/themes/romber-theme/theme-config/custom-post-types.php';
require_once WP_CONTENT_DIR . '/themes/romber-theme/theme-config/shortcodes.php';

// ACF
$files = glob(WP_CONTENT_DIR . '/themes/romber-theme/theme-config/acf/{*.php,*/*.php}', GLOB_BRACE);
