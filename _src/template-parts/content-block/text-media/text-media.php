...
$alignment = get_arg($args,'alignment');
...
<section class="content-section text-media-section <?php echo $bg_class; ?>">
    <div class="container <?php echo $media_position; ?>">
        <div class="text-elm animate slide-up-big <?php echo $alignment; ?>">
            <?php if ($title) : ?>
        ...
        <aside class="media-elm animate slide-left-big" style="<?php echo $media == null ? 'display:none;' : ''; ?>">
