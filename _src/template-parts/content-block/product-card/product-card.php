...
$hero_img = get_arg($args,'hero_img');
...
<section class="product-card content-section container <?php echo $order; ?>">
    ...
    <?php if($bg_img || $hero_img): ?>
        <aside class="product-image">
            ...
            <?php endif;?>
            <?php if($hero_img): ?>
                <img class="product-hero" src="<?php echo $hero_img["url"]; ?>" alt="<?php echo $hero_img["alt"]; ?>" title="<?php echo $hero_img["alt"]; ?>">
            <?php endif;?>
            <!-- <?php if($hero_link): ?>
