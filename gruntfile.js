    ...
    grunt.initConfig({
        ...
        'sftp-deploy': {
            dist: {
                ...
                /* exclusions: 
                    ['dist/romber-theme/theme-config/end-points.php',
                    'dist/romber-theme/theme-config/general_functions_end_points.php',
                    'dist/romber-theme/theme-config/encryption_QR.php',
                    'dist/romber-theme/functions.php',
                    'dist/romber-theme/scripts/appointment-edit-url.js',
                    'dist/romber-theme/scripts/qr-show.js',
                    'dist/romber-theme/scripts/QR_reader.js',
                    'dist/romber-theme/scripts/penalty.js'], */    
                localSep: '\\',
                progress: true
            }
        }
